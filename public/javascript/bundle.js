...
/***/ "./node_modules/react-google-login-component/dist/react-google-login-component.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/react-google-login-component/dist/react-google-login-component.js ***!
  \****************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var react_google_login_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-google-login-component */ "./node_modules/react-google-login-component/dist/react-google-login-component.js");
/* harmony import */ var react_google_login_component__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_google_login_component__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./User */ "./src/client/User.js");
/* harmony import */ var _LoginGoogleUser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./LoginGoogleUser */ "./src/client/LoginGoogleUser.js");
...
function (_React$Component) {
  ...
  function App() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(App).call(this)); //this.LoginGoogleUser = this.LoginGoogleUser.bind(this);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      userData: {}
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "responseGoogle", function (googleUser) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default()({
        ...
        if (resp.data.email_verified) {
          _this.getGoogleUser(resp.data.email);
        } else {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getGoogleUser", function (email) {
      var Googleuser = new _LoginGoogleUser__WEBPACK_IMPORTED_MODULE_3__["default"](email);
      var promise = Googleuser.fetchUser();
    ...
    _this.getGoogleUser = _this.getGoogleUser.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, this.state.userData.username ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_2__["default"], {
        user: this.state.userData
      })) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_google_login_component__WEBPACK_IMPORTED_MODULE_1__["GoogleLogin"], {
        socialId: "682669909656-oq0efd66585ha1r0e3vvtk6e4oj1mn1r.apps.googleusercontent.com",
...
var LoginGoogleUser = function LoginGoogleUser(email) {
  var _this = this;

  _classCallCheck(this, LoginGoogleUser);

  _defineProperty(this, "fetchUser", function () {
    console.log('logging in google user...');
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        method: 'get',
        url: 'http://localhost:8080/checkGoogleUser?email=' + _this.email,
        responseType: 'json'
      }).then(function (resp) {
...
/* harmony default export */ __webpack_exports__["default"] = (LoginGoogleUser);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util_ajax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../util/ajax */ "./src/util/ajax.js");
...
function selectPost() {
  ...
  var post = new _util_ajax__WEBPACK_IMPORTED_MODULE_0__["default"]("selectedPost/" + id, '');
  post.get().then(function (res) {
    if (res.data.postdata) {
      var data = res.data.postdata;
...
function getComments(blogID) {
  var comment = new _util_ajax__WEBPACK_IMPORTED_MODULE_0__["default"]("refreshComments/" + blogID, '');
  comment.get().then(function (res) {
    var cl = res.data.comments;
...
react_dom__WEBPACK_IMPORTED_MODULE_2___default.a.render(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_App__WEBPACK_IMPORTED_MODULE_3__["default"], null), document.getElementById('root'));
...
Ajax.prototype.get = function () {
  ...
  var request = axios__WEBPACK_IMPORTED_MODULE_0___default()({
    method: 'get',
    url: this.url,
    responseType: 'JSON' //headers:{"authorization": "bearer" + sessionStorage.getItem('AppreciateJWT'),"testing":"123"}

  });
  request.then(function (result) {
    return console.log('ajax firing: ' + result);
